...
export default function RoomDetailPage() {
  ...
  return (
    <div className={`sm-shell w-full flex-1 flex flex-col select-none relative overflow-x-hidden transition-transform duration-100 min-h-screen text-foreground font-mono ${
