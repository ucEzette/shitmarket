...
const programIdString = process.env.EXPO_PUBLIC_PROGRAM_ID || process.env.NEXT_PUBLIC_PROGRAM_ID || idlJson.address;
...
const fallbackUrls = [
  RPC_ENDPOINT,
  process.env.EXPO_PUBLIC_SOLANA_BACKUP_RPC_URL || process.env.NEXT_PUBLIC_SOLANA_BACKUP_RPC_URL || '',
  'https://api.devnet.solana.com',
