        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          {user && user.wallet ? (
            ...
            <button
              ...
              disabled={connecting}
              className="relative flex items-center gap-1.5 px-3 py-1.5 sm:px-6 sm:py-2.5 font-staatliches text-xs sm:text-lg tracking-wider uppercase bg-jeet-red text-white hover:bg-red-700 active:translate-y-1 transition-all rounded shadow-glow-jeet animate-pulse-fast border-b-4 border-red-950 font-bold"
            >
              {connecting ? (
                <>
